...
const Footer = () => {
  ...
  return (
    <footer className="absolute bottom-0 w-full font-poppins flex flex-row items-center justify-between sm:flex sm:flex-row sm:items-center sm:justify-between bg-white px-12">
      <div className="m-2">
        <Link to="/">
          <motion.div
