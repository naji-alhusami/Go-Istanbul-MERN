...
import ResponsiveNavbar from "./NavbarContent";
...
function Navbar() {
  ...
  return (
    ...
    md:static md:flex md:flex-col md:items-center md:justify-start md:w-20 md:h-screen md:rounded-none md:py-6 md:border-r md:border-red-200
  "
      >
